...
[![Build Status](https://github.com/zeriontech/google-wire/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/zeriontech/google-wire/actions)
[![godoc](https://godoc.org/github.com/zeriontech/google-wire?status.svg)][godoc]
...
[godoc]: https://godoc.org/github.com/zeriontech/google-wire
...
```shell
go install github.com/zeriontech/google-wire/cmd/wire@latest
```
